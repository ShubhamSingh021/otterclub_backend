  ...
  return res.status(200).json({
    ...
    data: {
      ...
      stats: {
        ...
        stat1Label: statsContent?.stat1Label || "Athletes & Members",
        stat1Value: statsContent?.stat1Value || "2,500+",
        stat2Label: statsContent?.stat2Label || "Coaching Sessions / Month",
        stat2Value: statsContent?.stat2Value || "320+",
        stat3Label: statsContent?.stat3Label || "Active Programs",
        stat3Value: statsContent?.stat3Value || "18",
        stat4Label: statsContent?.stat4Label || "Weekly Community Events",
        stat4Value: statsContent?.stat4Value || "12",
      },
    },
  });
};
